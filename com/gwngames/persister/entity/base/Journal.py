...
class Journal(BaseEntity):
    ...
    total_docs_2008 = Column(Integer, nullable=True)
    total_docs_3years = Column(Integer, nullable=True)
    total_refs_2008 = Column(Integer, nullable=True)
    ...
    refs_per_doc_2008 = Column(String, nullable=True)
    female_percent_2008 = Column(String, nullable=True)
